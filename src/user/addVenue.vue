          ...
          >
            ...
            >
              <b-form-input id="address"
                            ...
                            placeholder="address"
                            :state="address_state"></b-form-input>
            </b-form-group>
            ...
            >
              <b-form-input id="latitude"
                            ...
                            :state="latitude_state"></b-form-input>
            </b-form-group>
            ...
            >
              <b-form-input id="longitude"
                            ...
                            :state="longitude_state"></b-form-input>
            </b-form-group>
            ...
            >
              <b-form-input id="short-description"
                            ...
                            :state="short_description_state"></b-form-input>
            </b-form-group>
            ...
            >
              <b-form-textarea
                ...
                placeholder="eg opening times/days"
                rows="5"
              ></b-form-textarea>
            </b-form-group>
          </b-form-group>
        ...
        postNewVenue: function () {
          this.$http.post('http://127.0.0.1:4941/api/v1/venues',
            ...
            .then(function (response) {
              ...
              if(error.status == 400){
                alert("Bad Request: cannot post this venue");
              }
              if(error.status == 401){
                alert("Unauthorized: cannot post this venue");
              }
            });
        }
      }
